...
def _collect_rows(all_summaries: list[dict]) -> list[tuple[str, list]]:
    ...
    rows.append(("thin ways", _col("metrics.stage6.line_thin")))
    rows.append(("thick ways", _col("metrics.stage6.line_thick")))
    rows.append(("area ways", _col("metrics.stage6.area")))
    rows.append(("dropped", _col("metrics.stage6.dropped")))
    rows.append(("stage6 inputs", _col("metrics.stage6.total_input")))
